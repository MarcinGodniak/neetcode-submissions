    ...
    int maxProduct(vector<int>& nums) 
    {
        ...
        while(l < nums.size()){
            ...
            if(negative_count %2 !=0) {
                ...
                std::cout<< "left_accum "<< left_accum << "right_accum " << right_accum << std::endl;
                std::cout<< "l "<< l << " p " << p << " i_l " << i_l << " i_r "<< i_r << std::endl;
            ...
            std::cout<< "sum_l "<< sum_l << " sum_p " << sum_p << " max_product " << max_product << std::endl;
            std::cout<< "l "<< l << " p " << p << " max_product " << max_product << std::endl;
